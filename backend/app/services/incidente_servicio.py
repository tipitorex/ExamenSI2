...
from app.services.ia_servicio import clasificar_incidente_por_texto, generar_resumen_ia
...
def crear_incidente_con_ia(
    ...
    Retorna: (incidente, analisis_ia)
    """
    # 1. Clasificar con IA basado en la descripción
    analisis = clasificar_incidente_por_texto(payload.descripcion)
    
    # 2. Determinar prioridad final (la IA puede sobreescribir la del usuario)
    ...
    # 4. Crear incidente con datos de IA
    incidente = Incidente(
